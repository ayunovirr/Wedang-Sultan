...
<body>
		...
		<tr>
            ...
            ?>
                <tr>
					...
					<td><a href="vieweditnews.php?id=<?=$data['id'];?>" class="btn btn-secondary" role="button" aria-pressed="true">Edit</a>
					<td><a href="hapusnews.php?id=<?=$data['id'];?>" class="btn btn-dark" role="button" aria-pressed="true">Hapus</a>
                    </td>
                </tr>
            <?php 
            } 
	...
	<div class="row">
	<div class="col-md-4">
	<form method="post" action="tambahnews.php">
